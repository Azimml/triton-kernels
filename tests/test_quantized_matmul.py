...
from triton_kernels.quantized_matmul import Int8Linear, int8_gemm, int8_gemm_torch
...
class TestInt8Linear:
    ...
    def test_memory_reduction(self):
        ...
        int8_bytes = (
            out_features * in_features * 1 + out_features * 4
        )  # 1 byte per INT8 + 4 bytes per FP32 scale
