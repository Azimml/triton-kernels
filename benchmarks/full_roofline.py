...
def run_full_roofline(
    ...
    print("\nSpeedups:")
    print(
        f"  Triton RMSNorm vs PyTorch: {rmsnorm_results[0].mean_ms / rmsnorm_results[1].mean_ms:.2f}x"
    )
    print(
        f"  Triton Fused vs PyTorch Separate: {rmsnorm_results[2].mean_ms / rmsnorm_results[3].mean_ms:.2f}x"
    )
