...
from benchmarks.utils import BenchmarkResult, get_gpu_specs, plot_roofline
from triton_kernels.w4a16 import quantize_weight_int4_grouped, w4a16_gemm
...
def main() -> None:
    ...
    ap.add_argument(
        "--output", default=None, help="PNG path (e.g. docs/figures/w4a16_roofline.png)"
    )
    args = ap.parse_args()
